...
public class UsuarioController {
    ...
    @PutMapping("/endereco")
    public ResponseEntity<EnderecoDTO> updateEndereco(@RequestBody EnderecoDTO dto, @RequestParam("id") Long id){
        return ResponseEntity.ok(usuarioService.updateEndereco(id, dto));
    }

    @PutMapping("/telefone")
    public ResponseEntity<TelefoneDTO> updateTelefone(@RequestBody TelefoneDTO dto, @RequestParam("id") Long id){
        return ResponseEntity.ok(usuarioService.updateTelefone(id, dto));
    }
